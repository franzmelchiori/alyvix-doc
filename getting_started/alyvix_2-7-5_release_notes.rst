.. _alyvix_2-7-5_release_notes:

**************************
Alyvix 2.7.5 release notes
**************************


Alyvix 2.7.5 was released on January 23, 2019.
...
.. _alyvix_2-7-5_release_notes_bug_fixing:

=========
Bug fixes
=========

    * For now, we would like to continue working with RobotFramework IDE v1.5 (so, not the latest version)
